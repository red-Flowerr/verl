...
# Configuration
DATA_DIR = "/mnt/hdfs/tiktok_aiic/user/liuqian/verl_rl_checkpoints/verl-grpo-fix-ray_temp1.0_Qwen2.5-32B_simplelr_math_35/actor/eval_results"  # Root directory containing global_step folders
CHECKPOINT_PREFIX = "global_step_"
=======
import argparse

parser = argparse.ArgumentParser()
parser.add_argument("--data_dir", type=str, default="/mnt/hdfs/tiktok_aiic/user/liuqian/verl_rl_checkpoints/verl-grpo-fix-ray_temp1.0_Qwen2.5-32B_simplelr_math_35/actor/eval_results")
...
>>>>>>> remotes/origin/yuzhen_remove_format_reward
...
<<<<<<< HEAD
    jsonl_files = [f for f in os.listdir(checkpoint_path) if f.endswith(".jsonl")]
=======
...
<<<<<<< HEAD
        return [gr.update()]*4 + [gr.Slider(maximum=0)]
=======
...
<<<<<<< HEAD
            outputs=[input_text, pred_a, pred_b, diff_display, example_slider]
=======
...
>>>>>>> remotes/origin/yuzhen_remove_format_reward
    ...
    example_slider.change(
        ...
        inputs=[dataset_dropdown, checkpoint_a, checkpoint_b, example_slider],
<<<<<<< HEAD
        outputs=[input_text, pred_a, pred_b, diff_display]
=======
